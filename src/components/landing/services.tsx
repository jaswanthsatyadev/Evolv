...
import { Cpu, Image, SearchCode, Star, Sparkles } from "lucide-react";
      ...
      <div className="container mx-auto space-y-12 px-4 md:px-6">
        ...
        <div className="mx-auto grid items-stretch gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
          {services.map((service, index) => (
            <Card key={index} className="h-full flex flex-col border-accent/20 transition-all duration-300 hover:shadow-accent/10 hover:shadow-lg hover:-translate-y-2 hover:border-accent">
